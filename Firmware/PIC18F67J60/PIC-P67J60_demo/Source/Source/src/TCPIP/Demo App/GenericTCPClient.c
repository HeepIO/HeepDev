...
void GenericTCPClient(char* newMessage, BYTE* ServerName)
{
	...
	switch(GenericTCPExampleState)
	{
		case SM_HOME:
            ...
            //MySocket = TCPOpen((DWORD)"10.0.0.65", TCP_OPEN_RAM_HOST, 5000, TCP_PURPOSE_GENERIC_TCP_CLIENT);
...
//            
            //TCPPutROMString(MySocket, (ROM BYTE*)"hello World");
            TCPPutString(MySocket, newMessage);
